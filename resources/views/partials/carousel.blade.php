            ...
            <div class="item {{ ($counter == 1) ? 'active' : '' }}">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <img alt="{{ $c->title }}" class="img-responsive img-center" src="/images/shows/{{ $c->season }}/{{ $c->show_image }}" />
...
<div class="stage-bottom-bar hidden-xs">
    ...
    <h3 class="next-show">"An Almost Holy Picture" <small>Feb. 13 - 28, 2015</small>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://herbergertheater.ticketforce.com/eventperformances.asp?evt=246" target="_blank" class="btn btn-primary">Buy Tickets</a>
</h3>
</div>